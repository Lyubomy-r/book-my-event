...
public class EventController {
  ...
  @Operation(
      ...
      description =
          "Updates an existing event with the given ID. Only the event organizer can update the event.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<AppResponse> createUpdateEventRequest(
    ...
    log.info(
        "Class: {}, Method: updateEvent - Updating event with id: {}  authentication user {}",
        className,
        id,
        userId);
  ...
  public ResponseEntity<EventResponseDto> updateEventImage(
      ...
      @Parameter(description = "User Avatar  image (Max 1MB)", required = true)
          @RequestPart(value = "eventImage", required = true)
  ...
  @Operation(
      ...
      description =
          "Create request to delete an event by its ID. If the event does not exist, a 404 error is returned.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<AppResponse> createDeleteEventRequest(
      @PathVariable("eventId") String eventId,
      @RequestBody EventDeleteRequest eventDeleteRequest,
      @AuthenticationPrincipal Map<String, Object> principal) {
    String userId = (String) principal.get("id");
    log.info(
        "Class: {}, Method: createDeleteEventRequest - Delete event with id: {}  authentication user {}",
        className,
        eventId,
        userId);
    String messageResponse =
        eventService.createDeleteEventRequest(eventId, eventDeleteRequest, userId);
    AppResponse response = new AppResponse(HttpStatus.OK.value(), messageResponse);
    log.info(
        "Class: {}, Method: createDeleteEventRequest - return successfully code message.",
        className);
  ...
  @Operation(
      ...
      description =
          "Retrieves a paginated list of approved events based on various filters. "
              + "Example request: /api/v1/events/filtered?page=0&size=6")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "List of filtered approved events",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = Page.class),
  ...
  public ResponseEntity<Page<EventResponseDto>> getAllFilteredApprovedEvents(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              ...
              required = true,
              content = @Content(schema = @Schema(implementation = EventFilterRequest.class)))
          @RequestBody
          EventFilterRequest eventFilterRequest,
      @Parameter(
              description = "Pagination information (page, size). Example: /filtered?page=0&size=6")
          @PageableDefault(
              page = 0,
              size = 6,
              sort = "creationDate",
          ...
          Pageable pageable) {
    log.info(
        "Class: {}, Method: getAllFilteredApprovedEvents - Fetching all APPROVED events. param {}",
        className,
        eventFilterRequest);
  ...
  public ResponseEntity<Page<EventResponseDto>> getByOrganizersId(
      @PathVariable("userId") String userId,
      @PageableDefault(page = 0, size = 6, sort = "creationDate", direction = Sort.Direction.DESC)
          Pageable pageable) {
    Page<EventResponseDto> userResponse = eventService.getByOrganizersId(userId, pageable);
    log.info(
        "UserController::findUserCreatedEvents - /users/{userId} - Return User Info id: {} .",
        userId);
  ...
  @Operation(
      ...
      description =
          "Deletes an event by its ID. If the event does not exist, a 404 error is returned.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<AppResponse> deleteEvent(
    ...
    AppResponse response = new AppResponse(HttpStatus.OK.value(), "Event deleted successfully");
